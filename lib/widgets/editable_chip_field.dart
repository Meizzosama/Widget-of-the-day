...
const List<String> _cars = <String>[
'Ferrari',
  'Lamborghini',
  'Porsche',
  'Bugatti',
...
class EditableChipFieldExampleState extends State<EditableChipFieldExample> {
  ...
  List<String> _additions = <String>[_cars.first];
  ...
  Future<void> _onSearchChanged(String value) async {
    ...
    setState(() {
      _suggestions = results
          .where((String topping) => !_additions.contains(topping))
          .toList();
    });
  }
  ...
  void _onSubmitted(String text) {
    if (text.trim().isNotEmpty) {
      setState(() {
        _additions = <String>[..._additions, text.trim()];
      });
    } else {
  ...
  FutureOr<List<String>> _suggestionCallback(String text) {
    if (text.isNotEmpty) {
      return _cars.where((String topping) {
